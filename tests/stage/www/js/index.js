...
// stage/index.ts
var wasm = await instantiate2("Main");
...
debugger;
wasm.addEventListener("WebAssemblyExceptionEvent", (event) => {
  debugger;
  event.preventDefault();
  throw new WebAssembly.Exception("Hi");
});
try {
