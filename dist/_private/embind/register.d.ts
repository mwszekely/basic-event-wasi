 ...
 */
export declare function _embind_register(impl: InstantiatedWasi<{}>, namePtr: number, func: (name: string) => (void | Promise<void>)): void;
/**
 * Same as `_embind_register`, but for known (or synthetic) names.
 */
export declare function _embind_register_known_name(impl: InstantiatedWasi<{}>, name: string, func: (name: string) => (void | Promise<void>)): void;
